namespace CSharp_OOP_Basics_Exam___Avatar.Core
{
    ...
    using System.Linq;
    using System.Text;
    using CSharp_OOP_Basics_Exam___Avatar.Models;
    using CSharp_OOP_Basics_Exam___Avatar.Models.Benders;
    using CSharp_OOP_Basics_Exam___Avatar.Models.Monuments;
    ...
    public class NationsBuilder
    {
        ...
        public void IssueWar(string nationsType)
        {
            ...
            foreach (var nation in this.nations)
            {
                ...
                {
                    nation.Value.DestroyBendersAndMonuments();
                }
            }
        }
