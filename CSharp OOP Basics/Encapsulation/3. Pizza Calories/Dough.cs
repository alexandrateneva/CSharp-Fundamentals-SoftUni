...
public class Dough
{
    ...
    private double GetAllCaloriesByType()
    {
    ...
    private double GetAllCaloriesByTechnique()
    {
    ...
    {
        return 2 * this.weight * this.GetAllCaloriesByTechnique() * this.GetAllCaloriesByType();
    }
}
